package com.olympus.utils.sliding.data;

import com.olympus.exception.TimeWindowSlidingDataSourceException;
...
public interface TimeWindowSlidingDataSource {
    ...
    static TimeWindowSlidingDataSource defaultDataSource() {
        return new TimeWindowSlidingDataSource() {
            ...
            @Override
            public synchronized void allocAdoptRecord(int timeSlices, String recordKey) throws TimeWindowSlidingDataSourceException {
            ...
            @Override
            public synchronized int getAllocAdoptRecordTimes(int timeSlices, String recordKey) throws TimeWindowSlidingDataSourceException {
                Map<String, Integer> timeSlicesMap = timeWindowSlidingMap.get(String.valueOf(timeSlices));
                if (Objects.isNull(timeSlicesMap)) {
                    return 0;
                }
            ...
            @Override
            public synchronized void clearBetween(int fromIndex, int toIndex, int totalLength) throws TimeWindowSlidingDataSourceException {
            ...
            @Override
            public synchronized void clearSingle(int index) throws TimeWindowSlidingDataSourceException {
